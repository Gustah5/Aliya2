...
def banner():
    print
\033[;96m  __   __    __  _  _  __ \033[;93m
\033[;96m  (  ) (  )  (  )( \/ )(  )\033[;93m
\033[;96m  /__\  )(__  )(  \  / /__\\033[;93m
\033[;96m (_)(_)(____)(__)(__/ (_)(_)\033[;96m 
ok = []
cp = []
ttl =[]
...
def results(ramdhan,tricker):
        if len(ramdhan) !=0:
                print(("[OK] : "+str(len(Nazir))))
        if len(ramdhan) !=0:
                print(("[CP] : "+str(len(Ajmal))))
        if len(Nazir) ==0 and len(Ajmal) ==0:
                print("\n")
